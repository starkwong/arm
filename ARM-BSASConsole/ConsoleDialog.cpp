...
bool CConsoleDialog::Initialize(const char* file) {
	...
	*szTemp=0; 
	...
	UpdateConsoleText("");
	if (!m_fpSBCS) MessageBox("ｿ~｡GｵLｪkｸ・J sbcs.bin｡Aｳ讎r､ｸｭ^ｼﾆｦrｱNｵLｪkﾅ罕ﾜ｡C",NULL,MB_ICONERROR);
	return true;
}
...
void CConsoleDialog::OnPaint()
{
	...
	// TODO: ｦbｦｹ･[､JｱzｪｺｰTｮｧｳBｲzｱ`ｦ｡ｵ{ｦ｡ｽX
	// ｽﾐ､ﾅｩI･s CDialog::OnPaint() ｪｺｹﾏ､Tｮｧ
...
{
	// TODO: ｦbｦｹ･[､JｱzｪｺｰTｮｧｳBｲzｱ`ｦ｡ｵ{ｦ｡ｽXｩM (ｩﾎ) ｩI･sｹwｳ]ｭﾈ
